...
data_level2 = [
    ...
    [[[(255, 255, 0)], '-', 1], [[(255, 0, 0), "big"], '-', 4], [None], [None], [None], [[(255, 255, 0)], '-', 1],
     [None],
     [[(136, 136, 136)], '-', 1], [None], [[(136, 136, 136)], '-', 1], [None], [[(136, 136, 136)], '-', 1], [None],
     [[(136, 136, 136)], '-', 1], [[(255, 255, 0)], '-', 1]],
    [[[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [[(136, 136, 136)], '-', 1],
     [None], [[(136, 136, 136)], '-', 1], [None], [[(136, 136, 136)], '-', 1], [None], [[(136, 136, 136)], '-', 1],
     [None], [[(255, 255, 0)], '-', 1]],
    [[[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [None],
     [[(136, 136, 136)], '-', 1], [None], [[(136, 136, 136)], '-', 1], [None], [[(136, 136, 136)], '-', 1], [None],
     [[(136, 136, 136)], '-', 1], [[(255, 255, 0)], '-', 1]],
    [[[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [[(136, 136, 136)], '-', 1],
     [None], [[(136, 136, 136)], '-', 1], [None], [[(136, 136, 136)], '-', 1], [None], [[(136, 136, 136)], '-', 1],
    ...
    [[[(255, 255, 0)], '-', 1], [[(255, 255, 0)], '-', 1], [[(255, 255, 0)], '-', 1], [[(255, 255, 0)], '-', 1],
     ...
     [[(255, 255, 0)], '-', 1], [[(255, 255, 0)], '-', 1], [[(255, 255, 0)], '-', 1], [[(255, 255, 0)], '-', 1],
     [[(255, 255, 0)], '-', 1], [[(255, 255, 0)], '-', 1], [[(255, 255, 0)], '-', 1]],
    [[[(255, 255, 0)], '-', 1], [[(255, 0, 0), "big"], '-', 6], [None], [None], [None], [None], [None],
     [[(255, 255, 0)], '-', 1], [[(255, 0, 0), "big"], '-', 6], [None], [None], [None], [None], [None],
     [[(255, 255, 0)], '-', 1]],
    [[[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [None],
     [None], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1]],
    [[[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [None],
     [None], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1]],
    [[[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [None],
     [None], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1]],
...
data_level3 = [
    [[[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [None], [None], [None], [None], [None], [None], [None],
     [None], [None], [[(255, 102, 0)], '-', 1]],
    [[None], [[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [None], [None], [None], [None], [None], [None],
     [None], [[(255, 255, 0)], '-', 1], [[(255, 102, 0)], '-', 1]],
    [[None], [None], [[(255, 255, 0)], '-', 1], [None], [None], [None], [[(136, 136, 136)], '-', 2],
     [[(136, 136, 136)], '-', 1], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [None],
     [[(255, 102, 0)], '-', 1]],
    [[None], [None], [None], [[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [None], [None], [None],
     [[(255, 255, 0)], '-', 1], [None], [None], [[(255, 102, 0)], '-', 1]],
    [[None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [None],
     [[(255, 255, 0)], '-', 1], [None], [None], [None], [[(255, 102, 0)], '-', 1]],
    [[None], [None], [None], [None], [None], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [None], [None],
     [None], [None], [[(255, 102, 0)], '-', 1]],
    [[None], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [None], [None], [[(255, 255, 0)], '-', 1],
     [None], [None], [None], [None], [None], [[(255, 102, 0)], '-', 1]],
    [[None], [[(136, 136, 136)], '-', 2], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1],
     [[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [[(136, 136, 136)], '-', 2], [None],
     [[(255, 102, 0)], '-', 1]],
    [[None], [[(136, 136, 136)], '-', 2], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1],
     [[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [[(136, 136, 136)], '-', 2], [None],
     [[(255, 102, 0)], '-', 1]],
    [[None], [None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [None], [None], [[(255, 255, 0)], '-', 1],
     [None], [None], [None], [None], [None], [[(255, 102, 0)], '-', 1]],
    [[None], [None], [None], [None], [[(255, 255, 0)], '-', 1], [None], [None], [None], [None],
     [[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [[(255, 102, 0)], '-', 1]],
    [[None], [None], [None], [[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [None], [None],
     [[(255, 255, 0)], '-', 1], [None], [None], [None], [[(255, 102, 0)], '-', 1]],
    [[None], [None], [[(255, 255, 0)], '-', 1], [None], [None], [None], [[(136, 136, 136)], '-', 2],
     [[(136, 136, 136)], '-', 2], [None], [None], [None], [[(255, 255, 0)], '-', 1], [None], [None],
     [[(255, 102, 0)], '-', 1]],
    [[None], [[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [None], [None], [None], [None], [None], [None],
     [[(255, 255, 0)], '-', 1], [None], [[(255, 102, 0)], '-', 1]],
    [[[(255, 255, 0)], '-', 1], [None], [None], [None], [None], [None], [None], [None], [None], [None], [None], [None],
     [None], [[(255, 255, 0)], '-', 1], [[(255, 102, 0)], '-', 1]],
    [[[(255, 102, 0)], '-', 1], [[(255, 102, 0)], '-', 1], [[(255, 102, 0)], '-', 1], [[(255, 102, 0)], '-', 1],
     [[(255, 102, 0)], '-', 1], [[(255, 102, 0)], '-', 1], [[(255, 102, 0)], '-', 1], [[(255, 102, 0)], '-', 1],
     [[(255, 102, 0)], '-', 1], [[(255, 102, 0)], '-', 1], [[(255, 102, 0)], '-', 1], [[(255, 102, 0)], '-', 1],
